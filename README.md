...
[![Version: v1.3.3](https://img.shields.io/badge/version-v1.3.3-slategray?style=flat)](https://github.com/pgsty/pig/releases/tag/v1.3.3)
...
Install PostgreSQL 14 ~ 18 along with [481 extensions](https://pigsty.io/ext/list) on (`amd64` / `arm64`) with native OS package manager
...
That's it. All set! Check the [advanced usage](#advanced-usage) for details and the [full list of 481 available extensions](https://pigsty.io/ext/list/).
