...
func TestReloadResultDataJSONSerialization(t *testing.T) {
	...
	if int(result["extension_count"].(float64)) != 507 {
		t.Errorf("expected extension_count=507, got %v", result["extension_count"])
	}
...
func TestReloadResultDataYAMLSerialization(t *testing.T) {
	...
	if result.ExtensionCount != 507 {
		t.Errorf("expected ExtensionCount=507, got %v", result.ExtensionCount)
	}
...
func TestReloadCatalogResultDataSerialization(t *testing.T) {
	...
	if !strings.Contains(jsonStr, `"extension_count":507`) {
	...
	if !strings.Contains(yamlStr, "extension_count: 507") {
