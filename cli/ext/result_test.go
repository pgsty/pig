...
func TestReloadResultDataJSONSerialization(t *testing.T) {
	...
	if int(result["extension_count"].(float64)) != 508 {
		t.Errorf("expected extension_count=508, got %v", result["extension_count"])
	}
...
func TestReloadResultDataYAMLSerialization(t *testing.T) {
	...
	if result.ExtensionCount != 508 {
		t.Errorf("expected ExtensionCount=508, got %v", result.ExtensionCount)
	}
...
func TestReloadCatalogResultDataSerialization(t *testing.T) {
	...
	if !strings.Contains(jsonStr, `"extension_count":508`) {
	...
	if !strings.Contains(yamlStr, "extension_count: 508") {
