	...
	tests := []struct {
	...
	}{
		{
			...
			record: []string{
				...
				"Enables scalable inserts and complex queries for time-series data", "时序数据库扩展插件",
		...
		},
		{
			...
			record: []string{
				"1020", "timeseries", "pg_timeseries", "TIME", "https://github.com/tembo-io/pg_timeseries",
				...
				"Convenience API for Tembo time series stack", "Tembo时序数据API封装",
			...
			want: &Extension{
				...
				BadCase:     []string{},
				EnDesc:      "Convenience API for Tembo time series stack",
				ZhDesc:      "Tembo时序数据API封装",
